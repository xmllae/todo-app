...
(function(){
  ...
  css += '.sub-toolbar{display:grid!important;grid-template-columns:45fr 55fr!important;gap:6px!important;padding:8px 0!important;align-items:stretch;width:100%!important;box-sizing:border-box!important;}';
  css += '.sub-toolbar>div:first-child{min-width:0!important;width:100%!important;max-width:100%!important;}';
  css += '.sub-toolbar input{width:100%!important;min-width:0!important;max-width:100%!important;padding:6px 26px 6px 9px!important;font-size:.74rem!important;line-height:1.3!important;border-radius:8px!important;box-sizing:border-box!important;color:var(--text)!important;}';
  css += '.sub-toolbar select{width:100%!important;min-width:0!important;max-width:100%!important;padding:6px 22px 6px 8px!important;font-size:.74rem!important;line-height:1.25!important;border-radius:8px!important;box-sizing:border-box!important;border:1.5px solid var(--inp-bd)!important;color:var(--text2)!important;background-color:var(--inp-bg)!important;outline:0!important;cursor:pointer!important;letter-spacing:-.01em!important;}';
