...
(function(){
  ...
  css += '#subStats{grid-template-columns:repeat(2,1fr)!important;gap:10px!important;margin-bottom:14px!important;}';
  css += '.sub-stats-card{padding:12px!important;border-radius:12px!important;}';
  css += '.sub-stats-card h4{font-size:.8rem!important;margin-bottom:6px!important;}';
  css += '.sub-stats-card .value{font-size:1.8rem!important;}';
  css += '.sub-table-wrap{display:none!important;}';
  css += '.sub-card-list{display:flex!important;flex-direction:column;gap:10px;}';
  css += '.sub-toolbar{flex-direction:column!important;gap:8px!important;padding:10px 0!important;}';
  css += '.sub-toolbar select,.sub-toolbar input{width:100%!important;box-sizing:border-box!important;padding:8px 10px!important;font-size:.85rem!important;}';
  css += '.sub-tab-bar{display:flex;gap:2px;overflow-x:auto;-webkit-overflow-scrolling:touch;margin-bottom:12px;padding-bottom:4px;}';
  css += '.sub-tab{padding:6px 10px!important;font-size:.8rem!important;border-radius:8px!important;background:var(--hov);border:none!important;}';
  css += '.sub-tab.active{background:var(--acc);color:#fff!important;border-bottom:none!important;}';
  css += '.sub-tab-badge{font-size:.65rem!important;min-width:18px!important;height:18px!important;line-height:18px!important;}';
  css += '}';
