...
function renderWeekTaskScene(list,baseDs){
  ...
  const cardList=meta.days.map(function(ds,idx){
    ...
    const countHtml=dayPending?'<div class="week-day-count week-day-count-group" title="'+countTip+'" aria-label="'+countTip+'">'+todoControl+doneControl+'</div>':dayDoneRows.length?'<div class="week-day-count week-day-count-group is-single-action" title="'+countTip+'" aria-label="'+countTip+'">'+doneControl+'</div>':"";
