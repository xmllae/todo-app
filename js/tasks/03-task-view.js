...
function renderWeekTaskScene(list,baseDs){
  ...
  const dayStripHtml='<div class="week-view-day-strip" aria-label="\u672c\u5468\u6bcf\u65e5\u5f85\u529e\u6982\u89c8"><div class="week-view-day-pills">'+dailyOverview.map(function(day){
    const name=weekNames[day.idx],d=parseDS(day.ds),dateText=d?d.getMonth()+1+"/"+d.getDate():"",state=day.isOverdue?"\u903e\u671f "+day.pending+" \u9879":day.pending?day.pending+" \u9879\u5f85\u529e":day.total?"\u5df2\u5168\u90e8\u5b8c\u6210":"\u6682\u65e0\u4efb\u52a1",cls="week-view-day-pill"+(day.isToday?" is-today":"")+(day.isFocus?" is-focus":"")+(day.isOverdue?" is-overdue":"")+(day.pending?" has-pending":day.total?" is-clear":" is-empty"),dateLabel=dateText,valueHtml=day.isOverdue?'<span class="week-view-day-pill-state week-view-day-pill-state--overdue">'+WEEK_OVERDUE_ICON+'<span class="week-view-day-pill-state-text">\u903e\u671f</span><span class="week-view-day-pill-count">'+day.pending+'</span></span>':day.pending?'<span class="week-view-day-pill-state"><span class="week-view-day-pill-count">'+day.pending+'</span><span class="week-view-day-pill-state-text">\u5f85\u529e</span></span>':'<span class="week-view-day-pill-state week-view-day-pill-state--quiet"><span class="week-view-day-pill-state-text">'+(day.total?"\u5df2\u5b8c\u6210":"\u65e0\u4efb\u52a1")+'</span></span>';
