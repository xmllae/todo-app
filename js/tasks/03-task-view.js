...
const doneHiddenHint=hasDoneRows&&collapseCompletedRows?`<div class="subtask-completed-hidden-hint" onclick="event.stopPropagation();toggleCompletedSubtasksCollapse(${t.id})">\u5df2\u9690\u85cf ${subD} \u4e2a\u5df2\u5b8c\u6210\u5b50\u4efb\u52a1</div>`:"";
