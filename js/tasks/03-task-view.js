...
function weekOverdueIconHtml(wrapExtraClass,iconExtraClass,viewBox){const wrapClass="week-overdue-icon-wrap"+(wrapExtraClass?" "+wrapExtraClass:""),iconClass="week-overdue-icon"+(iconExtraClass?" "+iconExtraClass:""),box=viewBox||"0 0 24 24";return'<span class="'+wrapClass+'" aria-hidden="true"><svg class="'+iconClass+'" viewBox="'+box+'" focusable="false"><path d="M12 3 2.8 20h18.4L12 3Z" fill="none" stroke="currentColor" stroke-width="2.05" stroke-linejoin="round"></path><path d="M12 9v5" fill="none" stroke="currentColor" stroke-width="2.15" stroke-linecap="round"></path><circle cx="12" cy="17" r="1.2" fill="currentColor"></circle></svg></span>'}
...
const WEEK_RHYTHM_ICON_OVERDUE='<svg class="week-rhythm-node-svg" viewBox="0 0 16 16" focusable="false" aria-hidden="true"><circle cx="8" cy="8" r="6.25" fill="none" stroke="currentColor" stroke-width="1"></circle><path d="M8 5.05v3.05" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><circle cx="8" cy="10.85" r="0.82" fill="currentColor"></circle></svg>';
...
function rT(){
  ...
  if(!displayList.length&&!archVisible.length){
    ...
    list.innerHTML=`<div class="empty"><div class="em">\u2705</div><p class="empty-main">${isZero?"\u4eca\u5929\u4efb\u52a1\u5df2\u5168\u90e8\u5b8c\u6210":"\u6ca1\u6709\u5339\u914d\u7684\u4efb\u52a1"}</p><p class="empty-sub">${isZero?"\u4f11\u606f\u4e00\u4e0b\uff0c\u6216\u6dfb\u52a0\u65b0\u4efb\u52a1":"\u8bd5\u8bd5\u5176\u4ed6\u7b5b\u9009\u6761\u4ef6"}</p></div>`;
