...
function renderWeekTaskScene(list,baseDs){
  ...
  const quietHtml=quietCards.length?'<div class="week-quiet-days" aria-label="\u672c\u5468\u5df2\u6e05\u7a7a\u6216\u7a7a\u95f2\u65e5\u671f"><div class="week-quiet-days-label">\u5df2\u6e05\u7a7a / \u7a7a\u95f2\u65e5\u671f</div>'+quietCards.map(function(item){return item.html}).join("")+'</div>':"";
