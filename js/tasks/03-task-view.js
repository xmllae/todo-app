...
function renderOverdueTaskOverviewSidebar(state){
  ...
  shell.innerHTML='<div class="week-overview-head overdue-overview-head"><span class="week-overview-kicker">\u903e\u671f\u603b\u89c8</span></div><div class="overdue-overview-hero"><div class="overdue-overview-summary-main"><div class="overdue-overview-count"><strong>'+state.visibleCount+'</strong><div class="overdue-overview-count-copy"><span>\u5f53\u524d\u5f85\u5904\u7406</span><small>\u903e\u671f\u4efb\u52a1</small></div></div>'+summaryCopyHtml+'</div><div class="overdue-overview-metrics">'+metricsHtml+'</div></div><div class="overdue-overview-section"><div class="overdue-overview-section-head"><div class="overdue-overview-section-title">\u6700\u8fd1\u903e\u671f\u65e5\u671f</div></div><div class="overdue-overview-list">'+(listHtml||'<div class="overdue-overview-empty">\u5f53\u524d\u6ca1\u6709\u9700\u8981\u5904\u7406\u7684\u903e\u671f\u4efb\u52a1\u3002</div>')+'</div></div>'
}
